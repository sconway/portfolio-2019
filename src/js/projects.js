(function () {
    ...
    const projectData = {
        ...
        ticTacReact: {
            ...
            description:
                "This project is a web based version of the timeless game, Tic Tac Toe. It was built at a time when I was first starting to work with the ReactJS framework, as well as NodeJS and websockets, and this project seemed like a great opportunity to combine these technologies.",
            description2:
